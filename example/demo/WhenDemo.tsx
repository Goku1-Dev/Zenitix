            ...
            <div class="monitor-card-top">
              <div class="monitor-meta">
                <div class="monitor-tag">
                  ...
                  <span class="monitor-tag-text">Logic Monitor</span>
                </div>
                <div class="monitor-title">Reactive Scaling</div>
              </div>
          ...
          <div class="monitor-card">
            <div class="monitor-card-top">
              <div class="monitor-meta">
                <div class="monitor-tag">
                  <div class="monitor-pulse" />
                  <span class="monitor-tag-text">Trigger Monitor</span>
                </div>
                <div class="monitor-title">One-Time Trigger</div>
              </div>
              <div class="monitor-actions">
          ...
          <div class="monitor-card">
            <div class="monitor-card-top">
              <div class="monitor-meta">
                <div class="monitor-tag">
                  <div class="monitor-pulse" />
                  <span class="monitor-tag-text">Cart Monitor</span>
                </div>
                <div class="monitor-title">Discount Tiers</div>
              </div>
              <div class="monitor-actions">
            ...
            <div class="monitor-cell" style={{ borderBottom: '1px solid var(--border)' }}>
          ...
          <div class="monitor-card">
             <div class="monitor-card-top">
              <div class="monitor-meta">
                <div class="monitor-tag">
                  <div class="monitor-pulse" />
                  <span class="monitor-tag-text">Lifecycle Monitor</span>
                </div>
                <div class="monitor-title">Lifecycle Trace</div>
              </div>
              <div class="monitor-actions">
