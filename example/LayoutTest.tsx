    ...
    <div class="demo-module">
      <div class="demo-doc-pane">
        ...
        <div style={{ marginBottom: "40px" }}>
          ...
          >
            <h4 style={{ color: "var(--text)" }}>State Controls</h4>
            <div
            ...
            <div style="margin-top: 1rem; color: var(--text-dim); font-size: 14px;">
              Current User Role: <strong style="color: var(--text)">{() => role}</strong>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="demo-demo-pane">
        ...
        <div class="demo-interactive" style="display: flex; gap: 2rem; flex-wrap: wrap; align-items: flex-start; background: var(--bg-panel); padding: 1.5rem; border-radius: 8px;">
          <div
            class="layout-section"
            style="flex: 1; min-width: 300px; border: 1px solid var(--border); border-radius: 8px; overflow: hidden; position: relative; background: var(--bg-card);"
          >
            <h3
              style="background: var(--bg); color: var(--text); margin: 0; padding: 0.5rem 1rem; border-bottom: 1px solid var(--border);"
            >
              Dashboard Layout
            </h3>
            <div
